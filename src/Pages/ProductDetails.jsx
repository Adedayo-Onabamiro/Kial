    ...
    <div className="container flex md:flex-row flex-col items-center justify-between mx-auto p-4">
      ...
      <div className="mb-4 w-full md:w-5/12 m-4">
        <div className="bg-gray-200 h-96 flex items-center justify-center">
          <img src="./img/image 63.png" alt="Large Image" className="w-9/12 h-3/4 object-contain" />
        </div>
      </div>

      <div className="mb-4 w-full md:w-5/12 m-4">
        <div className="min-h-96 flex flex-col items-start justify-center p-4">
          <p className='font-bold text-xl my-2'>Havic HV G-92 Gamepad</p>
          <div className="flex items-start my-2 flex-col">
            ...
            <p className='text-xl my-2'>$192.00</p>
            <p className='my-2'> PlayStation 5 Controller Skin High quality vinyl with air channel adhesive for easy bubble free install & mess free removal Pressure sensitive. </p>
            ...
            <div className="my-2 w-full flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <div className="border border-black rounded my-2"> <div className="flex items-center">
                <FontAwesomeIcon
                  icon={faHeart}
            ...
            <div className='w-full flex flex-row items-center justify-start py-4 my-4 border border-black'>
              <div className='flex items-center justify-center w-fit md:mr-4'> <img src='./img/icon-delivery (1).png' className='h-9 w-9' /> </div>
              <span className='flex flex-col'> <p className='font-bold'> Free Delivery </p> <p className='underline text-sm'> Enter your postal code for Delivery Availability </p>  </span>
            </div>
            <div className='w-full flex flex-row items-center justify-start py-4 my-4 border border-black'>
              <div className=' flex items-center justify-center w-fit md:mr-4'> <img src='./img/Icon-return.png' className='h-9 w-9' /> </div>
              <span className='flex flex-col'> <p className='font-bold'> Return Delivery </p> <p className='underline text-sm'> Enter your postal code for Delivery Availability </p>  </span>
            </div>
