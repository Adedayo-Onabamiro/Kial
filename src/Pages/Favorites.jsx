...
export const Favorites = () => {
  return (
    <div className='h-auto w-full flex flex-row justify-center items-center border my-12'>
      <div className='w-10/12 h-full flex flex-col items-start justify-center'>
        <div className='w-full flex flex-row justify-between items-center'> <p>Wishlist (5)</p> <button className='px-6 py-4 border border-black'> Move All To Bag </button> </div>
