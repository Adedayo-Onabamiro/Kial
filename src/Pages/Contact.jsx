    ...
    <>
        ...
        <div className='md:h-full my-10 h-auto w-full flex flex-col md:flex-row items-center justify-center'>
            <div className='w-10/12 h-full flex flex-col md:flex-row items-center justify-between'>
                {/* left side */}
                <div className='w-full md:w-1/3 m-4 flex flex-col items-center justify-center'>
                    <div className='h-full w-full bg-white shadow-2xl flex flex-col justify-between p-[5%]'>
                        {/* up */}
                ...
                {/* right side */}
                <div className='w-full md:w-2/3 m-4 flex flex-col justify-center'>
                    <div className='h-full w-full bg-white shadow-2xl flex flex-col justify-between p-[5%]'>
                    <div className="flex flex-col h-full items-center justify-between">
                        {/* First Part */}
                        <div className="flex flex-wrap justify-between w-full mb-4">
                            <input type="text" placeholder="Name" className="flex-grow bg-gray-200 px-2 py-2 m-4" />
                            <input type="email" placeholder="Email" className="flex-grow bg-gray-200 px-2 py-2 m-4" />
                            <input type="tel" placeholder="Phone" className="flex-grow bg-gray-200 px-2 py-2 m-4" />
                        </div>
