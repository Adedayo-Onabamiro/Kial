...
//             {/* Login Form */}
//             <div class="flex flex-col md:items-start items-center justify-center h-auto">
//                 <h1 class="md:text-4xl text-xl text-center font-bold mb-4">Log in to Exclusive</h1>
//                 <p class="text-sm text-gray-600 mb-4 text-center">Enter your details below</p>
                
//                 <div class="md:w-10/12 w-full mb-4">
//                     <input type="text" placeholder="Email or Phone Number" class="w-full border-b border-gray-300 focus:border-gray-500 outline-none px-2 py-1" />
//                 </div>
...
//                 <button class="md:w-4/12 w-full bg-red-500 text-white py-2 rounded-md mb-2">Login</button>              
//                 <p class="text-sm text-red-500"> <a href="#" class="underline">Forgot Password?</a> </p>
//                 </div> 
